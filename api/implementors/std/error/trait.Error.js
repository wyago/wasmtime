...
implementors["wasi_common"] = [{"text":"impl Error for WasiCtxBuilderError","synthetic":false,"types":[]},{"text":"impl Error for Error","synthetic":false,"types":[]}];
implementors["wasi_crypto"] = [{"text":"impl Error for CryptoError","synthetic":false,"types":[]}];
implementors["wasmtime"] = [{"text":"impl Error for MemoryAccessError","synthetic":false,"types":[]},{"text":"impl Error for Trap","synthetic":false,"types":[]}];
